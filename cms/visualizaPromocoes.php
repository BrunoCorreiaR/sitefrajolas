...
if(isset($_GET['modo']))
{
    ...
    if($modo=='excluir')
    {
        ...
        $sql = "delete from tblpromocoes where id=".$id;
        mysql_query($sql);

        //Redireciona para a pagina inicial para apagar o GET da url
        header('location:visualizaPromocoes.php');
...
<html>
  ...
  <body>
      <div id="conte">
          ...
          <div id="main">
               <div id="falec_cabes">
                        <a>Tabela registros de promoções</a>
                     </div>
              <div id="janela_falecons">
                  ...
                  <table width="100%"  border="1" >
                        ...
                        <?php
                            $sql="select * from tblpromocoes order by id desc";
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <a class="ver" href="promocoesEditVisu.php?modo=visualisar&id=<?php echo($rsConteudo['id']) ?>" >
                                            <img src="imgCms/edit.png" alt="" title="Editar" />
                                        </a>

                                        <a href="visualizaPromocoes.php?modo=excluir&id=<?php echo($rsConteudo['id']) ?>">
