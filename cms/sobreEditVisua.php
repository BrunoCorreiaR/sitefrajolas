...
if(isset($_GET['modo']))
{
   ...
   if ($modo=='visualisar'){
        ...
        $sql="select * from tblsobre_a_pizzaria where id=".$id;
     ...
     if($_POST["btnsalvar"]=='salvar'){
         ...
         //caminho da pasta para onde as imgs serão armazenadas
            ...
            if(strstr($nome_arq,'.jpg')|| strstr($nome_arq,'.png')||strstr($nome_arq,'.gif'))
            {
                ...
                if (move_uploaded_file($_FILES['flefoto']['tmp_name'],$upload_file))
                {
                    ...
                    $sql="insert into tblsobre_a_pizzaria (titulo,descricao,foto)
         ...
         if(!empty($_FILES['flefoto']['name'])){
            ...
            if(strstr($nome_arq,'.jpg')|| strstr($nome_arq,'.png')||strstr($nome_arq,'.gif'))
            {
                ...
                if (move_uploaded_file($_FILES['flefoto']['tmp_name'],$upload_file))
                {
                    $sql="update tblsobre_a_pizzaria set titulo='".$titulo."',descricao='".$descricao."',foto='".$upload_file."' where id=".$_SESSION['id'];
                     
                    mysql_query($sql);
                    header('location:sobreEditVisua.php');
            ...
            $sql="update tblsobre_a_pizzaria set titulo='".$titulo."',descricao='".$descricao."' where id=".$_SESSION['id'];
            ...
            <!-- essa div para selecionar a pagina de mudança do conteudo-->
              <div id="segura_alinha_OpcPag">
                <div class="w3-card-4">
                  ...
                  <form class="w3-container" action="sobreEditVisua.php" enctype="multipart/form-data"  name="addsobre" method="post">
                    <p>
