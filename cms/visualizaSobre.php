...
if(isset($_GET['modo']))
{
    ...
    if($modo=='excluir')
    {
        ...
        $sql = "delete from tblsobre_a_pizzaria where id=".$id;
        mysql_query($sql);
                  ...
                  <table width="100%"  border="1" >
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <a class="ver" href="sobreEditVisua.php?modo=visualisar&id=<?php echo($rsConteudo['id']) ?>" >
                                            <img src="imgCms/edit.png" alt="" title="Editar" />
                                        </a>

                                        <a href="visualizaSobre.php?modo=excluir&id=<?php echo($rsConteudo['id']) ?>">
