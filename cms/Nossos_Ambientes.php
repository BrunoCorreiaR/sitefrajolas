...
if(isset($_GET['modo']))
{
   ...
   if ($modo=='visualisar'){
        ...
        $sql="select * from tblNossos_Ambientes where id=".$id;
    ...
    }else if(isset($_GET['modo']))
    {
        ...
        if($modo=='excluir')
        {
            ...
            $sql = "delete from tblNossos_Ambientes where id=".$id;
            mysql_query($sql);
         ...
         //caminho da pasta para onde as imgs serão armazenadas
            ...
            if(strstr($nome_arq,'.jpg')|| strstr($nome_arq,'.png')||strstr($nome_arq,'.gif'))
            {
                ...
                if (move_uploaded_file($_FILES['flefoto']['tmp_name'],$upload_file))
                {
                    ...
                    $sql="insert into tblNossos_Ambientes (titulo,descricao,foto)
            ...
            <!-- essa div para selecionar a pagina de mudança do conteudo-->
              <div id="segura_alinha_OpcPag">
                <div class="w3-card-4">
                  ...
                  <form class="w3-container" action="Nossos_Ambientes.php" enctype="multipart/form-data"  name="addsobre" method="post">
                    <p>
          ...
          <div id="main">
              ...
              <div id="janela_falecons">
                  ...
                  <table width="100%"  border="1" >
                        ...
                        <?php
                            $sql="select * from tblNossos_Ambientes order by id desc";
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <a class="ver" href="Nossos_Ambientes.php?modo=visualisar&id=<?php echo($rsConteudo['id']) ?>" >
                                            <img src="imgCms/edit.png" alt="" title="Editar" />
                                        </a>

                                        <a href="Nossos_Ambientes.php?modo=excluir&id=<?php echo($rsConteudo['id']) ?>">
